...
var queries = ['DROP TABLE IF EXISTS Users, Photos, Follows, Streams', 
    ...
    "INSERT INTO Users (user_name, name, password, sid) VALUES ('username2', 'Chong-Wei Lee', '" + crypto.createHash('md5').update('password2').digest('hex') + "', '00000');",
    "INSERT INTO Users (user_name, name, password, sid) VALUES ('username3', 'Dan Lin', '" + crypto.createHash('md5').update('password3').digest('hex') + "', '00000');",
    "INSERT INTO Users (user_name, name, password, sid) VALUES ('username4', 'Yun Lei Zhao', '" + crypto.createHash('md5').update('password4').digest('hex') + "', '00000');",
    "INSERT INTO Users (user_name, name, password, sid) VALUES ('username5', 'Yong Dae Lee', '" + crypto.createHash('md5').update('password5').digest('hex') + "', '00000');",
